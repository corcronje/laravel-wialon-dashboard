...
@section('content')
    <x-details :items="[
        ...
        'Fuel' => number_format($unit->fuel_consumed_litres) . ' Litres' . ' (' . $unit->wialon_fuel_consumption_sensor_id . '*' . $unit->wialon_fuel_consumption_sensor_calibration_factor .')',
        ...
        'Kilometers' => number_format($unit->mileage_km) . ' Km' . ' (' . $unit->wialon_mileage_sensor_id . '*' . $unit->wialon_mileage_sensor_calibration_factor .')',
        ...
        'Fuel Consumption' => number_format($unit->fuel_consumption_litres_per_km, 2) . ' Litres/Km' . ' (' .number_format($unit->fuel_consumption_km_per_litre, 2) . ' Km/Litre)',
